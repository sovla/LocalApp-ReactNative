...
const ModalPopup: React.FC<ModalPopupProps> = ({onClose}) => {
    ...
    const {data: List, isLoading} = useApi<ModalPopupAPI | null, any>(null, 'home_popup.php');
            ...
            <View style={styles.dimTouch}>
                <View style={styles.mainView}>
                                    ...
                                    return (
                                        <View
                                            style={{
                                                ...
                                                backgroundColor: page === i ? Theme.color.whiteGray_EE : '#fff5',
                                                borderRadius: 100,
                                            }}
                                        />
                                    );
                    ...
                    <View style={styles.footerButton}>
                        <TouchableOpacity onPress={onPressNeverLookAgain} style={styles.buttonTouch}>
