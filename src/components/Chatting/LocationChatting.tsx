...
const LocationChatting: React.FC<LocationChattingProps> = ({
  date,
  content,
  isCheck,
  isMy,
      ...
      <View
        ...
        <TouchableOpacity style={styles.mapContentTouch}>
          ...
          <Image
            source={
              isMy
                ? require('@assets/image/arrow_right_white.png')
                : require('@assets/image/arrow_right_new.png')
            }
            style={styles.mapContentArrowImage}
          />
        </TouchableOpacity>
      </View>
    </View>
