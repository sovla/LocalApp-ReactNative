    ...
    return isMyProduct ? (
                ...
                <View
                    ...
                    <View style={styles.row}>
                        <View style={styles.innerImageView}>
                            <Image source={require('@assets/image/dummy.png')} style={styles.innerImage} />
                        </View>
                        <View style={{width: getPixel(120), marginLeft: getPixel(10)}}>
                            <WhiteText fontSize={`${12 * fontSize}`} numberOfLines={2} style={styles.marginBottom5}>
                    ...
                    <View style={styles.paddingTop14}>
                        <Button onPress={onPressProduct} fontSize={13} content={t('moreInformation')} fontColor={Theme.color.white} style={styles.button} />
                    </View>
                </View>
            </View>
        </View>
        ...
        <View
            ...
            <View style={styles.imageView}>
                <Image source={require('@assets/image/dummy.png')} style={styles.image} />
            </View>
            ...
            <View
                ...
                <View
                    ...
                    <View style={styles.row}>
                        ...
                        <View style={{width: getPixel(120), marginLeft: getPixel(10)}}>
                            <Text fontSize={`${12 * fontSize}`} numberOfLines={2} style={styles.marginBottom5}>
                                Smart Insulation Cup Water Bottle Led Temperature Dis...
                            </Text>
                    ...
                    <View style={styles.paddingTop14}>
                        <Button onPress={onPressProduct} content={t('moreInformation')} fontColor={Theme.color.white} fontSize={13} style={{...styles.button, backgroundColor: Theme.color.gray}} />
                    </View>
                </View>
            </View>
        </View>
