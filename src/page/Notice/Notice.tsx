...
export default function Notice({navigation}: ScreenNoticeProps) {
    ...
    const {data, isLoading, isError, errorMessage} = useApi<NoticeApi['T'], NoticeApi['D']>(null, 'notice_list.php', {
        mt_idx: user?.mt_idx ?? '',
    });
            ...
            <View style={styles.noticeView}>
                <TouchableOpacity onPress={onPress}>
                    ...
                    <View style={styles.contentView}>
                        ...
                        {item.new_check === 'Y' && <AutoHeightImage source={NewIcon} width={getPixel(16)} style={{marginLeft: getPixel(6)}} />}
                    </View>
                </TouchableOpacity>
            </View>
        );
